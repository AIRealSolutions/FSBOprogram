  ...
  return (
    <main className="container grid">
      <div className="card panel">
        ...
        <p className="muted">Use password login or a magic link. After login we’ll send you to: <span style={{ fontWeight: 700 }}>{next}</span></p>
      </div>
      ...
      <div className="card panel grid" style={{ maxWidth: 640 }}>
        ...
        <p className="small muted">
          Need an account? <Link href="/register" style={{ fontWeight: 800 }}>Create one</Link>.
        </p>
      </div>
    </main>
  );
