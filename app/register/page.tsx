  ...
  return (
    <main className="container grid">
      <div className="card panel">
        ...
        <p className="muted">After signup/confirmation we’ll send you to: <span style={{ fontWeight: 700 }}>{next}</span></p>
      </div>
      ...
      <div className="card panel grid" style={{ maxWidth: 640 }}>
        ...
        <p className="small muted">
          Already have an account? <Link href={`/login?next=${encodeURIComponent(next)}`} style={{ fontWeight: 800 }}>Log in</Link>.
        </p>
      </div>
    </main>
  );
